...
class PricesCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('price_level_code');
        CRUD::column('price');
        CRUD::column('starting_date')->type('date');
        CRUD::column('ending_date')->type('date');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('product_sku');
        CRUD::field('price_level_code');
        CRUD::field('price');
        CRUD::field('starting_date')->type('date');
        CRUD::field('ending_date')->type('date');
